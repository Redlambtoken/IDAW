       ...
       $mymenu = array(
        ...
        if($currentPageId == "admin" || $currentPageId == "secret"){
            ...
            foreach($mymenu as $pageId => $pageParameters) {
                    echo '<a class="btn btn-primary" href="' . $pageId . '.php">' . $pageId . '</a>';       
            }
            echo '<a class="btn btn-primary" id="currentpage" href="index.php">' . $currentPageId . '</a>';
        }
        else {
            echo '<div class="menuPerso bg-dark">
            <h1 style="color: white;">Accueil</h1>
            ...
            foreach($mymenu as $pageId => $pageParameters) {
                if($pageId == $currentPageId){
                    echo '<a class="btn btn-primary" id="currentpage" href="' . $currentPageId . '.php">' . $currentPageId . '</a>';
                }
                else{
                    echo '<a class="btn btn-primary" href="' . $pageId . '.php">' . $pageId . '</a>';
                }
